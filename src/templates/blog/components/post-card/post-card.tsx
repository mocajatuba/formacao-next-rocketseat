        ...
        <Link href={`/blog/${slug}`} className="w-full max-w-2xl rounded-[12px] border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:border-[1px] hover:border-blue-300">
            ...
            <div className="p-2 rounded-md overflow-hidden">
                ...
                <div className="px-2 mt-4 space-y-4">
                    ...
                    {/* Post footer */}
                    {/* Imagem antes sem reestruturação
                        <div className="flex items-center gap-3 border-t border-gray-400 py-4">
                            <div className="relative h-5 w-5 md:h-6 md:w-6 overflow-hidden rounded-full boder-blue-200 border-[1px]">
                                <Image 
                                    src={author.avatar}
                                    alt=""
                                    fill
                    ...
                    <div className="flex items-center gap-3 border-t border-gray-400 py-4">
                        <Avatar.Container>
                            {/* size="xs" já vem como padrão xs não precisa informar */}
