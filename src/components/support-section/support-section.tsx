...
export const SupporSection = () => {
    return (
        <section className="pb-8 mb:py-10 to-gray-700">
           {/*<section className="container pb-8 mb:py-10 bg-gradient-to-r from-gray-500 to-gray-700"> */} 
           <div className="container flex flex-col items-center gap-12">
                <h2 className={`${ptSansCaption.className} text-balance text-center text-heading-lg text-gray-100`}>Sua loja de afiliados, simples, do jeito que deveria ser</h2>
