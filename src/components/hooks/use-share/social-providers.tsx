import { Facebook, Linkedin, Slack, Twitter, AtSign } from 'lucide-react';
...
export const SOCIAL_PROVIDERS = {
    ...
    threads: {
        ...
        shareUrl: (config: ShareConfig) => `https:/threads.net/intenet/post?text=${encodeURIComponent(config.url)}&text=${encodeURIComponent(config.title || '')}`
    }
